...
<template>
    <AppLayout :title="isEditing ? 'Edit Customer' : 'Creating a new Customer'">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ isEditing ? 'Edit Customer: ' + customer.first_name + ' ' + customer.last_name : 'Creating a new Customer' }}
            </h2>
        </template>
                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">Social title</label>
                            ...
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4"><span class="text-red-500">*</span> First name</label>
                            ...
                            <!-- Last name -->
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4"><span class="text-red-500">*</span> Last name</label>
                                <div class="w-full sm:w-2/3">
                            ...
                            <!-- Email -->
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4"><span class="text-red-500">*</span> Email address</label>
                                <div class="w-full sm:w-2/3">
                            ...
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">
                                    <span v-if="!isEditing" class="text-red-500">*</span> Password
                                </label>
                                <div class="w-full sm:w-2/3">
                            ...
                            <div class="flex flex-col sm:flex-row items-center" v-if="form.password !== '' || !isEditing">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">Confirm Password</label>
                                <div class="w-full sm:w-2/3">
                            ...
                            <!-- Birthday -->
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">Birthday</label>
                                <div class="w-full sm:w-2/3">
                            ...
                            <!-- Enabled -->
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">Enabled</label>
                                <div class="w-full sm:w-2/3 flex">
                                    <div class="flex rounded-md shadow-sm">
                                        <button type="button" @click="form.is_enabled = true" :class="['px-4 py-1.5 text-sm font-medium rounded-l-md border', form.is_enabled ? 'bg-cyan-500 text-white border-cyan-500' : 'bg-white text-gray-400 border-gray-300 hover:bg-gray-50']">YES</button>
                            ...
                            <!-- Newsletter -->
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">Newsletter</label>
                                <div class="w-full sm:w-2/3 flex">
                                    <div class="flex rounded-md shadow-sm">
                                        <button type="button" @click="form.newsletter = true" :class="['px-4 py-1.5 text-sm font-medium rounded-l-md border', form.newsletter ? 'bg-cyan-500 text-white border-cyan-500' : 'bg-white text-gray-400 border-gray-300 hover:bg-gray-50']">YES</button>
                            ...
                            <!-- Opt-in -->
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">Opt-in</label>
                                <div class="w-full sm:w-2/3 flex">
                                    <div class="flex rounded-md shadow-sm">
                                        <button type="button" @click="form.opt_in = true" :class="['px-4 py-1.5 text-sm font-medium rounded-l-md border', form.opt_in ? 'bg-cyan-500 text-white border-cyan-500' : 'bg-white text-gray-400 border-gray-300 hover:bg-gray-50']">YES</button>
                                        <button type="button" @click="form.opt_in = false" :class="['px-4 py-1.5 text-sm font-medium rounded-r-md border border-l-0', !form.opt_in ? 'bg-red-400 text-white border-red-400' : 'bg-white text-gray-400 border-gray-300 hover:bg-gray-50']">NO</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row items-center">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4">Admin Role</label>
                                <div class="w-full sm:w-2/3 flex">
                                    <div class="flex rounded-md shadow-sm">
                                        <button type="button" @click="form.role = 'admin'" :class="['px-4 py-1.5 text-sm font-medium rounded-l-md border', form.role === 'admin' ? 'bg-purple-500 text-white border-purple-500' : 'bg-white text-gray-400 border-gray-300 hover:bg-gray-50']">ADMIN</button>
                                        <button type="button" @click="form.role = 'user'" :class="['px-4 py-1.5 text-sm font-medium rounded-r-md border border-l-0', form.role === 'user' ? 'bg-gray-500 text-white border-gray-500' : 'bg-white text-gray-400 border-gray-300 hover:bg-gray-50']">USER</button>
                                    </div>
                                </div>
                            </div>

                            <!-- Group access table -->
                            <div class="flex flex-col sm:flex-row items-start pt-4">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-gray-600 text-left sm:text-right sm:pr-4 mt-2"><span class="text-red-500">*</span> Group access</label>
                                <div class="w-full sm:w-2/3">
                            ...
                            <div class="flex flex-col sm:flex-row items-center pt-2">
                                <label class="w-full sm:w-1/3 text-sm font-medium text-blue-500 text-left sm:text-right sm:pr-4">Default customer group</label>
                                <div class="w-full sm:w-2/3">
