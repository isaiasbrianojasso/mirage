                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                        <div class="w-full md:w-1/3">
                            <h3 class="text-lg font-medium text-gray-900 mb-1">Listado de Ubicaciones</h3>
                            <p class="text-xs text-gray-500">Agrega las direcciones de tus tiendas físicas o talleres para que los clientes puedan encontrarlas en el mapa.</p>
                        </div>
                        <div class="w-full md:w-1/3">
