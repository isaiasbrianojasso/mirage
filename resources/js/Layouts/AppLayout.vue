            ...
            <div class="flex-1 flex flex-col w-0 overflow-hidden">
                ...
                <header class="flex items-center justify-between shrink-0 h-16 bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 shadow-sm">
                    ...
                    <div class="flex items-center ml-4 space-x-4">
                        ...
                        <!-- Cart Link -->
                        <a :href="route('cart.index')" class="relative p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none transition-colors">
                            <span class="sr-only">Ver carrito</span>
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                            </svg>
                            <span v-if="$page.props.cart_count > 0" class="absolute top-0 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white transform translate-x-1/4 -translate-y-1/4 bg-indigo-600 rounded-full">
