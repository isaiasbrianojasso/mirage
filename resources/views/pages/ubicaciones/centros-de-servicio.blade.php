...
<script id="wpsl-info-window-template" type="text/template">
    <div data-store-id="<%= id %>" class="wpsl-info-window">
		<p>
			...
			<strong><a href="https://mirage.mx/ubicaciones/centros-de-servicio/&lt;%=&#32;url&#32;%&gt;"><%= store %></a></strong>
			<% } else { %>
			<strong><%= store %></strong>
			<% } %>
			<span><%= address %></span>
...
<script id="wpsl-listing-template" type="text/template">
    <li data-store-id="<%= id %>">
		<div class="wpsl-store-location">
			...
			<% if ( url ) { %>
			<p><a href="https://mirage.mx/ubicaciones/centros-de-servicio/&lt;%=&#32;url&#32;%&gt;">Página del distribuidor</a></p>
			<% } %>
