...
<body class="wp-singular post-template-default single single-post postid-21097 single-format-standard wp-theme-genesis wp-child-theme-digital-pro theme-genesis woocommerce-no-js custom-header header-image header-full-width full-width-content genesis-breadcrumbs-hidden genesis-footer-widgets-visible elementor-default elementor-kit-23667" itemscope itemtype="https://schema.org/WebPage">
...
<ul class="genesis-skip-link"><li><a href="#genesis-content" class="screen-reader-shortcut"> Saltar al contenido principal</a></li><li><a href="#genesis-footer-widgets" class="screen-reader-shortcut"> Saltar al pie de página</a></li></ul> <div  class="site-inner"><div  class="content-sidebar-wrap"><main class="content" id="genesis-content"><article class="post-21097 post type-post status-publish format-standard has-post-thumbnail category-blog entry" aria-label="La garantía Mirage" itemscope itemtype="https://schema.org/CreativeWork"><header class="entry-header"><h1 class="entry-title" itemprop="headline">La garantía Mirage</h1>
</header><div class="entry-content" itemprop="text">
<h2 class="wp-block-heading">Respalda su elección protegiendo su ahorro.</h2>



<p class="wp-block-paragraph">Todos los propietarios de equipos Mirage cuentan con una garantía válida que protege la operación y el correcto funcionamiento del equipo contra defectos de fabricación, algunos componentes debido al trabajo que realizan puede recibir una cobertura especial y a través del registro de los equipos en nuestro portal (registratuequipo.com) se puede ampliar la cobertura de la misma o extender el periodo de protección sobre algunos componentes como el compresor, la atención a las reclamaciones de garantía por parte del proveedor es un derecho para el usuario que está respaldado por la ley federal de protección al consumidor en la república mexicana.</p>



<p class="wp-block-paragraph">El periodo válido para la reclamación de garantía de un producto empieza a correr a partir del momento de la compra y su finalización se determina en la póliza que se incluye en el empaque del equipo o la que se descarga del portal de registro, conserve estos documentos junto a la factura o ticket, tome en cuenta que algunos tickets de venta de impresión térmica podrían perder legibilidad, le recomendamos hacer copias de estos y conservarlos junto al original.</p>



<p class="wp-block-paragraph"><strong>¿Son los defectos en el equipo causados por el traslado o manejo del producto?</strong></p>



<p class="wp-block-paragraph">En algunos casos particulares, aparecen canales informales para la venta de equipos. Los portales de ventas en linea de terceros o las redes sociales en general no son considerados una forma segura para la adquisición de productos Mirage porque la vinculación de su producto con el punto de venta es compleja o inexistente y estos equipos pueden -en algunos casos- pertenecer a lotes adquiridos de manera ilícita por quien sea el vendedor y sin relación alguna con Mirage. No caiga en estafas, consulte a través de nuestras redes sociales o por correo electrónico si el vendedor de su equipo está respaldado por la marca o por uno de nuestros distribuidores autorizados.</p>



<p class="wp-block-paragraph">Uno de los problemas recurrentes al comprar con un tercero no autorizado se presenta cuando el equipo se daña durante el traslado. El daño sufrido por el traslado en paquetería o el manejo incorrecto del equipo no está contemplado en la póliza de garantía.</p>



<p class="wp-block-paragraph"><strong>¿Ha reportado la situación al técnico que le instaló?</strong></p>



<p class="wp-block-paragraph">En el caso de los equipos de Aire Acondicionado, la instalación requiere un análisis previo del área que le corresponde enfriar para verificar que la capacidad del equipo seleccionado cumpla con los requisitos del área. El proceso de instalación es de complejidad técnica y podría parecer algo sencillo a simple vista, pero requiere capacitación especial además de un set de herramientas que no son comunes, como una bomba de vacío y el equipo necesario para el manejo de la condensadora durante el montaje.</p>



<p class="wp-block-paragraph">En el caso de los equipos de línea blanca, es de especial consideración leer los manuales de operación y uso para operar el equipo correctamente y con seguridad, la falta de esto puede resultar en daños en el equipo que no son cubiertos por la póliza de garantía.<strong><br></strong></p>



<p class="wp-block-paragraph"><strong>¿Notificó a la tienda donde compró el equipo?</strong></p>



<p class="wp-block-paragraph">El departamento de garantías de Mirage atiende las reclamaciones a través de los distribuidores que son quienes comercializan el producto al público en general, quienes a su vez corroboran la situación del caso conforme a lo establecido en la póliza de garantía incluida con el equipo al momento de la compra.</p>



<p class="wp-block-paragraph"><strong>¿Qué hay sobre los equipos comprados en cadenas comerciales?</strong></p>



<p class="wp-block-paragraph">La tienda departamental donde compró el equipo tiene asignado un centro de servicio autorizado certificado por Mirage para atender sus instalaciones, le recomendamos encarecidamente que instale a través de este centro de servicio autorizado para evitar retrasos en la posible gestión de su garantía.</p>



<p class="wp-block-paragraph">En todos los casos es necesario un diagnóstico profesional que de respaldo a su reclamación y este requisito es indispensable para atender la garantía.</p>
<!--<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
			xmlns:dc="http://purl.org/dc/elements/1.1/"
			xmlns:trackback="http://madskills.com/public/xml/rss/module/trackback/">
		<rdf:Description rdf:about="https://mirage.mx/blog/garantia-mirage/"
    dc:identifier="https://mirage.mx/blog/garantia-mirage/"
    dc:title="La garantía Mirage"
    trackback:ping="https://mirage.mx/blog/garantia-mirage/trackback/" />
</rdf:RDF>-->
