...
<body class="wp-singular page-template-default page page-id-1198 page-child parent-pageid-1133 wp-theme-genesis wp-child-theme-digital-pro theme-genesis woocommerce-no-js custom-header header-image header-full-width full-width-content genesis-breadcrumbs-hidden genesis-footer-widgets-visible elementor-default elementor-kit-23667" itemscope itemtype="https://schema.org/WebPage">
...
<ul class="genesis-skip-link"><li><a href="#genesis-content" class="screen-reader-shortcut"> Saltar al contenido principal</a></li><li><a href="#genesis-footer-widgets" class="screen-reader-shortcut"> Saltar al pie de página</a></li></ul> <div  class="site-inner"><div  class="content-sidebar-wrap"><main class="content" id="genesis-content"><article class="post-1198 page type-page status-publish entry" aria-label="¿Cómo ser distribuidor?" itemscope itemtype="https://schema.org/CreativeWork"><header class="entry-header"><h1 class="entry-title" itemprop="headline">¿Cómo ser distribuidor?</h1>
</header><div class="entry-content" itemprop="text">
<p class="wp-block-paragraph">El proceso para convertirse en distribuidor mayorista directo requiere del acercamiento a través de los distribuidores con cuentas activas afiliados a la marca Mirage. </p>



<h2 class="wp-block-heading">Solo nuestros distribuidores mayoristas oficiales pueden cotizarle equipos o discutir precios negociables por volumen. Puede encontrar un mayorista cerca de usted en el siguiente mapa:</h2>
...
<h3 class="wp-block-heading has-text-align-left">Este es el sitio oficial de la marca Mirage.</h3>



<p class="has-text-align-left wp-block-paragraph">La dirección postal de nuestras oficinas corporativas es Calle Puebla #270 Sur, Col. Centro. Ciudad Obregón, Sonora, Mx. C.P. 85000 </p>
...
<script id="wpsl-info-window-template" type="text/template">
    <div data-store-id="<%= id %>" class="wpsl-info-window">
		<p>
			...
			<strong><a href="https://mirage.mx/corporativo/como-ser-distribuidor-mirage/&lt;%=&#32;url&#32;%&gt;"><%= store %></a></strong>
			<% } else { %>
			<strong><%= store %></strong>
			<% } %>
			<span><%= address %></span>
...
<script id="wpsl-listing-template" type="text/template">
    <li data-store-id="<%= id %>">
		<div class="wpsl-store-location">
			...
			<% if ( url ) { %>
			<p><a href="https://mirage.mx/corporativo/como-ser-distribuidor-mirage/&lt;%=&#32;url&#32;%&gt;">Página del distribuidor</a></p>
			<% } %>
