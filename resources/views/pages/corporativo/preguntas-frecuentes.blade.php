...
<body class="wp-singular page-template-default page page-id-1170 page-child parent-pageid-1133 wp-theme-genesis wp-child-theme-digital-pro theme-genesis woocommerce-no-js custom-header header-image header-full-width full-width-content genesis-breadcrumbs-hidden genesis-footer-widgets-visible elementor-default elementor-kit-23667" itemscope itemtype="https://schema.org/WebPage">
...
<ul class="genesis-skip-link"><li><a href="#genesis-content" class="screen-reader-shortcut"> Saltar al contenido principal</a></li><li><a href="#genesis-footer-widgets" class="screen-reader-shortcut"> Saltar al pie de página</a></li></ul> <div  class="site-inner"><div  class="content-sidebar-wrap"><main class="content" id="genesis-content"><article class="post-1170 page type-page status-publish entry" aria-label="Preguntas Frecuentes" itemscope itemtype="https://schema.org/CreativeWork"><header class="entry-header"><h1 class="entry-title" itemprop="headline">Preguntas Frecuentes</h1>
</header><div class="entry-content" itemprop="text"><h2><strong>¿Qué precio tienen los equipos Mirage?</strong></h2>
<p>El precio de nuestros productos puede consultarlo directamente con cualquiera de nuestros distribuidores.</p>
<p>Para encontrar su distribuidor más cercano puede ingresar a la siguiente página: <a href="https://mirage.mx/tiendas-oficiales/">Mapa de ubicación para distribuidores Mirage.</a></p>
<h2><strong>¿Qué significan las siglas CF en el Display?</strong></h2>
<p>Las iniciales CF= Clean Filter indican que los filtros del evaporador deben limpiarse, le recomendamos levantar la tapa, retirar los filtros y lavarlos con agua y jabón .<br />
Una vez realizado esto, favor de bajar y subir el switch del voltaje de luz para que se reinicie el equipo y de esta manera se efectúen los cambios, con esto deberán desaparecer las iniciales en el display. Le recomendamos ampliamente realizar la limpieza cada una o dos semanas dependiendo de la circulación del aire en el área.</p>
<p>NOTA: Las siglas CF indican únicamente un recordatorio de limpieza y NO sugieren alguna falla en su equipo.</p>
<h2><strong>¿Cómo puedo registrar la extensión de garantía de mi equipo?</strong></h2>
<p>Para el registro de extensión de su garantía es necesario ingresar a la siguiente página: www.registratuequipo.com</p>
<p>Al entrar ingrese a la sección de Registra tu equipo para que a continuación aparezca un cuadro de texto para capturar el número de serie de la condensadora de su equipo.</p>
<p>Con esto usted registra la extensión de garantía en el motor del condensador únicamente, el equipo ya cuenta con un año de garantía, 3 meses en tarjetas electrónicas y en su control remoto.</p>
<h2><strong>¿Dónde puedo adquirir refacciones y/o controles para mi equipo?</strong></h2>
<p>Usted puede ahora cotizar refacciones con nuestros mayoristas Autorizados Mirage de su localidad o contactar al más cercano a su ciudad (manejan envío por paquetería a cualquier punto de la República Mexicana) en el Directorio de Tiendas Mirage.</p>
<h2><strong>¿Qué significan las siglas SEER?</strong></h2>
<p>Proviene del inglés Seasonal Energy Efficiency Ratio, o bien al español REEE = Relación de Eficiencia Energética Estacional, lo cual nos indica el rango de eficiencia energética que alcanza un equipo bajo diferentes condiciones climáticas simulando diferentes estaciones del año.</p>
<h2><strong>¿Cómo encuentro un distribuidor o centro de servicio cercano?</strong></h2>
<p>Para centros de servicio ingresar a: <a href="../../centros-de-servicio">https://mirage.mx/centros-de-servicio/</a></p>
<p>Para encontrar una tienda puede usar los mapas de las páginas de <a href="https://mirage.mx/tiendas-oficiales/">Tiendas Oficiales</a> o <a href="../../distribuidores">Distribuidores Autorizados</a>.</p>
