...
<body class="archive tax-product_cat term-flux term-390 wp-theme-genesis wp-child-theme-digital-pro theme-genesis woocommerce woocommerce-page woocommerce-no-js custom-header header-image header-full-width full-width-content genesis-breadcrumbs-hidden genesis-footer-widgets-visible elementor-default elementor-kit-23667" itemscope itemtype="https://schema.org/WebPage">
...
<ul class="genesis-skip-link"><li><a href="#genesis-content" class="screen-reader-shortcut"> Saltar al contenido principal</a></li><li><a href="#genesis-footer-widgets" class="screen-reader-shortcut"> Saltar al pie de página</a></li></ul> <div  class="site-inner"><div  class="content-sidebar-wrap"><main class="content" id="genesis-content"><div class="archive-description taxonomy-archive-description taxonomy-description"><h1 class="archive-title">Flux</h1></div><div class="woocommerce-notices-wrapper"></div><p class="woocommerce-result-count" role="status" aria-relevant="all" data-is-sorted-by="true">
	Mostrando todos los 2 resultados<span class="screen-reader-text">Sorted by latest</span></p>
<ul class="products columns-5">
<li class="entry has-post-thumbnail product type-product post-23435 status-publish first instock product_cat-boilers product_cat-flux product_cat-linea-blanca product_cat-todo product_tag-linea-blanca virtual product-type-simple">
