...
<ul class="genesis-skip-link"><li><a href="#genesis-content" class="screen-reader-shortcut"> Saltar al contenido principal</a></li><li><a href="#genesis-footer-widgets" class="screen-reader-shortcut"> Saltar al pie de página</a></li></ul> <div  class="site-inner"><div  class="content-sidebar-wrap"><main class="content" id="genesis-content"><article class="post-1264 page type-page status-publish entry" aria-label="Soporte al producto" itemscope itemtype="https://schema.org/CreativeWork"><header class="entry-header"><h1 class="entry-title" itemprop="headline">Soporte al producto</h1>
				...
				<div class="elementor-element elementor-element-74522cb5 e-flex e-con-boxed e-con e-parent" data-id="74522cb5" data-element_type="container" data-e-type="container">
					<div class="e-con-inner">
				<div class="elementor-element elementor-element-70e3ec25 elementor-widget elementor-widget-text-editor" data-id="70e3ec25" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
									<h2>Sobre la instalación de equipos</h2>
<p>Si compró su equipo en una tienda departamental o de autoservicio que incluía el servicio de instalación gratis, por favor vaya al final de esta página y de &#8220;clic&#8221; en el botón para iniciar una solicitud de servicio.</p>
<h2>Registra tu Minisplit y protege tu inversión.</h2>
<p>Al hacerlo en <a href="https://registratuequipo.com">registratuequipo.com</a>, podrás activar el proceso para obtener la extensión de garantía del compresor, siempre que cumplas con los requisitos establecidos por Mirage, como una instalación realizada por personal capacitado y el mantenimiento preventivo en tiempo y forma. El registro es rápido y sencillo: solo necesitas capturar el número de serie de tu unidad y completar tus datos. No lo dejes para después; haz tu registro a tiempo y mantén tu equipo respaldado.</p>
<h2>¿Ha reportado la situación al técnico que le instaló?</h2>
...
<p><!-- /wp:paragraph --></p>								</div>
				...
				<div class="elementor-element elementor-element-aba8569 elementor-align-center elementor-widget elementor-widget-button" data-id="aba8569" data-element_type="widget" data-e-type="widget" data-widget_type="button.default">
				<div class="elementor-widget-container">
									<div class="elementor-button-wrapper">
					<a class="elementor-button elementor-button-link elementor-size-sm" href="https://b2b.mirage.mx/defaultv1.aspx?_m_=POSTVENTAFP1&#038;d=SX1&#038;tt=3D7FC03E-EBF1-471D-9105-B337AA1BFC35" target="_blank" rel="nofollow">
						<span class="elementor-button-content-wrapper">
						<span class="elementor-button-icon">
				<i aria-hidden="true" class="far fa-calendar-check"></i>			</span>
									<span class="elementor-button-text">De clic aquí para iniciar la solicitud de servicio</span>
					</span>
					</a>
				</div>
								</div>
				</div>
				<div class="elementor-element elementor-element-8d0f0cc elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile elementor-widget elementor-widget-text-editor" data-id="8d0f0cc" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
									<h2><span style="font-size: 3rem; text-align: var(--text-align);">¿Necesita asistencia telefónica?</span></h2>
<p><!-- /wp:heading --><!-- wp:paragraph --></p>
<p>Contamos con una linea disponible con horario de atención de 8:00 a 18:00 horas en tiempo del Pacifico, si necesita hablar con nosotros por favor marque al <a href="https://mirage.mx/?page_id=23889" data-type="page" data-id="23889">01 800 420 5878</a>.</p>
