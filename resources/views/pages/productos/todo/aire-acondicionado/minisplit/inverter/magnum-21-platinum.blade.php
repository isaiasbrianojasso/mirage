...
<div class="su-column su-column-size-1-3"><div class="su-column-inner su-u-clearfix su-u-trim">
<div class="sue-icon-text" data-url="" data-target="self" style="min-height:58px;padding-left:72px;color:#333333"><div class="sue-icon-text-icon" style="color:#333333;font-size:48px;width:48px;height:48px"><img decoding="async" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E" style="width:48px" alt="" data-lazy-src="{{ asset('vendor/mirage-assets/wp-content/uploads/2022/08/x-blade.svg') }}" /><noscript><img decoding="async" src="../../../../../../wp-content/uploads/2022/08/x-blade.svg" style="width:48px" alt="" /></noscript></div><div class="sue-icon-text-content sue-content-wrap" style="color:#333333">
<h2>X-BLADE</h2>
...
<div class="su-column su-column-size-1-3"><div class="su-column-inner su-u-clearfix su-u-trim">
<div class="sue-icon-text" data-url="" data-target="self" style="min-height:58px;padding-left:72px;color:#333333"><div class="sue-icon-text-icon" style="color:#333333;font-size:48px;width:48px;height:48px"><img decoding="async" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E" style="width:48px" alt="" data-lazy-src="{{ asset('vendor/mirage-assets/wp-content/uploads/2022/08/eco-power.svg') }}" /><noscript><img decoding="async" src="../../../../../../wp-content/uploads/2022/08/eco-power.svg" style="width:48px" alt="" /></noscript></div><div class="sue-icon-text-content sue-content-wrap" style="color:#333333">
<h2>ECO POWER</h2>
...
<div class="su-column su-column-size-1-3"><div class="su-column-inner su-u-clearfix su-u-trim">
<div class="sue-icon-text" data-url="" data-target="self" style="min-height:58px;padding-left:72px;color:#333333"><div class="sue-icon-text-icon" style="color:#333333;font-size:48px;width:48px;height:48px"><img decoding="async" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E" style="width:48px" alt="" data-lazy-src="{{ asset('vendor/mirage-assets/wp-content/uploads/2022/08/rest-mode.svg') }}" /><noscript><img decoding="async" src="../../../../../../wp-content/uploads/2022/08/rest-mode.svg" style="width:48px" alt="" /></noscript></div><div class="sue-icon-text-content sue-content-wrap" style="color:#333333">
<h2>REST MODE</h2>
