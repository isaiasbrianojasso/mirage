...
<div class="su-row">
<div class="su-column su-column-size-1-2"><div class="su-column-inner su-u-clearfix su-u-trim">
<div class="sue-icon-text" data-url="" data-target="self" style="min-height:58px;padding-left:72px;color:#333333"><div class="sue-icon-text-icon" style="color:#333333;font-size:48px;width:48px;height:48px"><img decoding="async" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E" style="width:48px" alt="" data-lazy-src="{{ asset('vendor/mirage-assets/wp-content/uploads/2022/12/x32_library-app.svg') }}" /><noscript><img decoding="async" src="../../../../../../wp-content/uploads/2022/12/x32_library-app.svg" style="width:48px" alt="" /></noscript></div><div class="sue-icon-text-content sue-content-wrap" style="color:#333333">
<h2>LIBRARY APP</h2>
<p>Aplicación móvil, para descifrar la causa de la alerta emitida con el Digital-Asisted-Diagnosys.</p>
</div><div style="clear:both;height:0"></div></div>
</div></div>
<div class="su-column su-column-size-1-2"><div class="su-column-inner su-u-clearfix su-u-trim">
<div class="sue-icon-text" data-url="" data-target="self" style="min-height:58px;padding-left:72px;color:#333333"><div class="sue-icon-text-icon" style="color:#333333;font-size:48px;width:48px;height:48px"><img decoding="async" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E" style="width:48px" alt="" data-lazy-src="{{ asset('vendor/mirage-assets/wp-content/uploads/2022/12/x32_xcool.svg') }}" /><noscript><img decoding="async" src="../../../../../../wp-content/uploads/2022/12/x32_xcool.svg" style="width:48px" alt="" /></noscript></div><div class="sue-icon-text-content sue-content-wrap" style="color:#333333">
<h2>X-COOL</h2>
