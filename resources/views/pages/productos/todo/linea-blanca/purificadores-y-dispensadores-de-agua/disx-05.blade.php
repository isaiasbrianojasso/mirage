...
<h3 class="woocommerce-product-documents-title">Documentación</h3><div class="woocommerce-product-documents-1070 woocommerce-product-documents">
		...
		<div>
			<ul>
					...
					<li><a href="https://images.mirage.mx/pdf/specs/Disx05.pdf" target="_self">Disx 05 - Especificaciones del Producto</a></li>
...
jQuery(function($) { 		$( '.woocommerce-product-documents-1070' ).accordion( {
