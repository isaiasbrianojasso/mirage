...
<head>
    ...
    <link rel="preload" data-rocket-preload as="image" href="{{ company_logo() }}" fetchpriority="high">
    <meta name='robots' content='max-image-preview:large' />
    <link rel='dns-prefetch' href='https://fonts.googleapis.com/' />
    <link rel='dns-prefetch' href='https://code.ionicframework.com/' />
    <link href='https://fonts.gstatic.com' crossorigin rel='preconnect' />
    <link rel="canonical" href="{{ url('catalogo/todo/') }}" />
    <!-- Genesis Open Graph -->
    <meta property="og:title" content="{{ company('catalog_all_products_title', 'Todos los Productos ' . company_name()) }}" />
    ...
    <link rel='stylesheet' id='digital-pro-css' href="{{ asset('wp-content/themes/digital-pro/style.css?ver=1.1.3') }}"
        media='all' />
                ...
                <nav class="nav-primary" aria-label="Principal" itemscope
                    ...
                    <div class="wrap">
                        <ul id="menu-header-menu" class="menu genesis-nav-menu menu-primary js-superfish">
                            <li id="menu-item-976"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-976">
                                <a href="{{ url('/') }}" itemprop="url"><span itemprop="name">Inicio</span></a></li>
                            <li id="menu-item-20281"
                                class="menu-item menu-item-type-taxonomy menu-item-object-product_cat current-menu-item menu-item-has-children menu-item-20281">
                                <a href="{{ url('catalogo/todo/') }}" aria-current="page" itemprop="url"><span
                            ...
                            <li id="menu-item-1255"
                                ...
                                <a href="{{ url('comunicacion/sala/') }}" itemprop="url"><span
                                        itemprop="name">{{ company('catalog_menu_company_label', company_name()) }}</span></a>
                                <ul class="sub-menu">
                                    ...
                                    <li id="menu-item-23968"
                                        ...
                                        <a href="{{ url('comunicacion/blog/') }}" itemprop="url"><span
                                            itemprop="name">{{ company('catalog_menu_blog_label', company_name() . ' Blog') }}</span></a></li>
                                </ul>
                            </li>
                            <li id="menu-item-3471"
                                class="btn-tienda menu-item menu-item-type-custom menu-item-object-custom menu-item-3471">
                                <a target="_blank"
                                    href="{{ company_store_url() }}"
                                    itemprop="url"><span itemprop="name">{{ company('catalog_store_label', 'Tienda ' . company_name()) }}</span></a></li>
                        </ul>
                    </div>
                </nav>
            </div>
            ...
            <div class="content-sidebar-wrap">
                <main class="content" id="genesis-content">
                    <div class="archive-description taxonomy-archive-description taxonomy-description">
                        <h1 class="archive-title">{{ company('catalog_all_products_heading', 'Todos los Productos ' . company_name()) }}</h1>
                    </div>
                    <div class="woocommerce-notices-wrapper"></div>
                    <ul class="products columns-5">
                        <li class="product-category product first">
                            <a aria-label="Visitar la categoría de producto Aire Acondicionado"
                                href="{{ url('catalogo/todo/aire-acondicionado/') }}"><img fetchpriority="high"
                                    src="{{ company_logo() }}"
                                    alt="Aire Acondicionado" width="500" height="500"
                                    />
                                <h2 class="woocommerce-loop-category__title">
                                    Aire Acondicionado <mark class="count">(49)</mark>
                                </h2>
                            </a>
                        </li>
                        <li class="product-category product">
                            <a aria-label="Visitar la categoría de producto Línea Blanca"
                                href="{{ url('catalogo/todo/linea-blanca/') }}"><img
                                    src="{{ asset('uploads/2020/03/LMS016M-01-500x500.jpg') }}" alt="Línea Blanca"
                                    width="500" height="500"
                                    srcset="{{ asset('uploads/2020/03/LMS016M-01-500x500.jpg') }} 500w, {{ asset('uploads/2020/03/LMS016M-01-300x300.jpg') }} 300w, {{ asset('uploads/2020/03/LMS016M-01-1024x1024.jpg') }} 1024w, {{ asset('uploads/2020/03/LMS016M-01-150x150.jpg') }} 150w, {{ asset('uploads/2020/03/LMS016M-01-768x768.jpg') }} 768w, {{ asset('uploads/2020/03/LMS016M-01-600x600.webp') }} 600w"
                                    sizes="(max-width: 500px) 100vw, 500px" />
                                <h2 class="woocommerce-loop-category__title">
                                    Línea Blanca <mark class="count">(29)</mark>
                                </h2>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="wrap">
                    ...
                    <section id="custom_html-2" class="widget_text widget widget_custom_html">
                        <div class="widget_text widget-wrap">
                            <div class="textwidget custom-html-widget">
                                <h4>Soporte</h4>
                                <ul>
                                    <li><a href="{{ url('corporativo/preguntas-frecuentes/') }}">Preguntas
                                            Frecuentes</a></li>
                                    <li><a href="https://www.registratuequipo.com/">Registro de equipos</a></li>
                                    <li><a href="{{ url('ubicaciones/centros-de-servicio/') }}">Centros de Servicio</a>
                                    </li>
                                </ul>
                                <p>
                                ...
                                <ul>
                                    <li><a href="{{ url('apps/wifi-app/') }}">App de Control WiFi</a></li>
                                        <li><a href="{{ url('apps/mirage-home/') }}">{{ company('catalog_app_home_label', company_name() . ' Home') }}</a></li>
                                        <li><a href="{{ rtrim(company('company_website_url', url('/')), '/') . '/apps/codigos-de-diagnostico/' }}">C&oacute;digos de
                                ...
                                <h4>Corporativo</h4>
                                <ul>
                                        <li><a href="{{ rtrim(company('company_website_url', url('/')), '/') . '/corporativo/semblanza-empresarial/' }}">Semblanza
                                            Empresarial</a></li>
                                        <li><a href="{{ rtrim(company('company_website_url', url('/')), '/') . '/corporativo/certificaciones/' }}">Certificaciones</a>
                                    </li>
                                        <li><a href="{{ rtrim(company('company_website_url', url('/')), '/') . '/corporativo/infraestructura-operativa/' }}">Infraestructura
                                            Operativa</a></li>
                                        <li><a href="{{ rtrim(company('company_website_url', url('/')), '/') . '/corporativo/infraestructura-tecnologica/' }}">Infraestructura
                                            Tecnol&oacute;gica</a></li>
                                    <li><a href="{{ company_store_url() }}">Tienda en linea</a></li>
                                </ul>
                                <p>
                                <div class="su-divider su-divider-style-default"
                ...
                <div class="widget-area footer-widgets-2 footer-widget-area">
                    <section id="custom_html-7" class="widget_text widget widget_custom_html">
                        <div class="widget_text widget-wrap">
                            <h3 class="widgettitle widget-title">{{ company('catalog_footer_brand_title', company_name() . ' Electrodomésticos') }}</h3>
                            <div class="textwidget custom-html-widget">
                                ...
                                <p>Ampliamos nuestra gama de productos introduciendo componentes de <a
                                        href="{{ url('catalogo/todo/linea-blanca/') }}">linea blanca</a> que integran
                                    los mismos estándares de eficiencia en ahorro energético logrados con nuestros
                                    diseños exclusivos, los modelos de la linea <a
                                        href="{{ url('catalogo/todo/aire-acondicionado/minisplit/inverter/') }}">Magnum.</a>
                                </p>
                                <div class="su-spacer" style="height:20px"></div>
                                <img src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E"
                                    alt="" class="wp-image-20305"
                                    data-lazy-src="{{ company('catalog_logistics_image', asset('uploads/2020/06/centro_logistico_mirage-1024x464.jpg')) }}" /><noscript><img
                                        src="{{ company('catalog_logistics_image', asset('uploads/2020/06/centro_logistico_mirage-1024x464.jpg')) }}" alt=""
                                        class="wp-image-20305" /></noscript>
                                <div class="su-spacer" style="height:20px"></div>
                                <div class="su-divider su-divider-style-default"
                                    style="margin:15px 0;border-width:3px;border-color:#ffffff"></div>
                                ...
                                <p>Nuestra ingeniería de producto incluye la retroalimentación de una amplia red
                                    ...
                                    equipos {{ company_name() }} cada año.</p>
                                <div class="su-divider su-divider-style-default"
                                    style="margin:15px 0;border-width:3px;border-color:#ffffff"></div>
                                <h5>La máxima eficiencia</h5>
                                <p>Cada nuevo modelo que {{ company_name() }} lanza al mercado ofrece mejoras en modos de operación,
        ...
        <footer class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
            <div class="wrap">
                <div class="pagebottominfo">
                    <p>&copy; Copyright 2021 <a href="{{ url('/') }}">{{ company_name_full() }}</a> &middot; Todos los derechos
                        reservados &middot; <a href="{{ url('avisos/aviso-de-privacidad/') }}">Aviso de privacidad</a>
                    </p>
                </div>
                <p></p>
                        ...
                        <ul id="menu-footer-menu" class="menu genesis-nav-menu menu-secondary js-superfish">
                            <li id="menu-item-16"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-16"><a
                                    href="{{ company('b2b_portal_url', '#') }}" itemprop="url"><span itemprop="name">Centro
                                        Digital</span></a></li>
                            <li id="menu-item-17"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-17"><a
                                    href="{{ company('certification_portal_url', '#') }}" itemprop="url"><span
                                        itemprop="name">{{ company('catalog_certification_label', 'Certificacion ' . company_name()) }}</span></a></li>
                            <li id="menu-item-14"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-14"><a
                                    target="_blank" href="{{ social_facebook() }}" itemprop="url"><span
...
" use strict";var r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof
        ...
        i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(e,t,n){return
        t&&i(e.prototype,t),n&&i(e,n),e}}();function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a
        class as a function")}var t=function(){function
        n(e,t){i(this,n),this.browser=e,this.config=t,this.options=this.browser.options,this.prefetched=new
        Set,this.eventTime=null,this.numOnHover=0}return
        e(n,[{key:"init",value:function(){!this.browser.supportsLinkPrefetch()||this.browser.isDataSaverModeOn()||this.browser.isSlowConnection()||(this.regex={excludeUris:RegExp(this.config.excludeUris,"i"),images:RegExp(".("+this.config.imageExt+")$","i"),fileExt:RegExp(".("+this.config.fileExt+")$","i")},this._initListeners(this))}},{key:"_initListeners",value:function(e){-1<this.config.onHoverDelay&&document.addEventListener("mouseover",e.listener.bind(e),e.listenerOptions),document.addEventListener("mousedown",e.listener.bind(e),e.listenerOptions),document.addEventListener("touchstart",e.listener.bind(e),e.listenerOptions)}},{key:"listener",value:function(e){var
        ...
        i=this,r=setTimeout(function(){if(r=null,0===i.numOnHover)setTimeout(function(){return i.numOnHover=0},1e3);else
        if(i.numOnHover>i.config.rateThrottle)return;i.numOnHover++,i._addPrefetchLink(e)},this.config.onHoverDelay);t.addEventListener(n,function e(){t.removeEventListener(n,e,{passive:!0}),null!==r&&(clearTimeout(r),r=null)},{pass [truncated]
}());
