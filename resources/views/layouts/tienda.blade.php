  ...
  <script type="application/ld+json">
    {
      ...
      "url" : "/tienda/",
          ...
          "url":"/tienda_assets/img/mirage-logo-1534899548.jpg"
            ...
            "potentialAction": {
        "@@type": "SearchAction",
        "target": "/tienda/busqueda?search_query={search_term_string}",
...
<link  rel="preload stylesheet"  as="style" href="/themes/warehouse/assets/css/font-awesome/css/font-awesome-preload.css"
  ...
  <script>
        ...
        var iqitcompare = {"nbProducts":{{ count(session()->get('compare_list', [])) }}};
  ...
  <a href="{{ route('tienda.index') }}">
    <img class="logo img-fluid"
         src="/tienda_assets/img/mirage-logo-1534899548.jpg"
                  alt="{{ \App\Models\CompanySetting::get('company_name', 'Tienda en Línea') }}"
         width="307"
         height="43"
    >
  </a>
...
<!-- /Block search module TOP -->
    ...
    <div id="ps-shoppingcart"
         ...
         data-refresh-url="/tienda/carrito/ajax">
        @php
            $cartCount = 0;
            $cartTotal = 0;
            if(session()->has('cart')) {
...
<div class="container iqit-megamenu-container d-none d-lg-block"><div id="iqitmegamenu-wrapper" class="iqitmegamenu-wrapper iqitmegamenu-all">
	...
	<li class="mobile-menu__tab  d-flex flex-wrap js-mobile-menu__tab"><a  href="{{ route('tienda.index') }}"  class="flex-fill mobile-menu__link ">Inicio</a></li><li class="mobile-menu__tab  d-flex flex-wrap js-mobile-menu__tab"><a  href="{{ route('tienda.category', optional(\App\Models\Category::where('slug', '10-refacciones')->orWhere('slug', preg_replace('/^\d+-/', '', '10-refacciones'))->first())->uuid ?? '10-refacciones') }}"  class="flex-fill mobile-menu__link ">Refacciones</a></li><li class="mobile-menu__tab  d-flex flex-wrap js-mobile-menu__tab"><a  href="{{ route('tienda.category', optional(\App\Models\Category::where('slug', '11-aire-acondicionado')->orWhere('slug', preg_replace('/^\d+-/', '', '11-aire-acondicionado'))->first())->uuid ?? '11-aire-acondicionado') }}"  class="flex-fill mobile-menu__link ">Aire Acondicionado</a></li><li class="mobile-menu__tab  d-flex flex-wrap js-mobile-menu__tab"><a  href="{{ route('tienda.category', optional(\App\Models\Category::where('slug', '13-linea-blanca')->orWhere('slug', preg_replace('/^\d+-/', '', '13-linea-blanca'))->first())->uuid ?? '13-linea-blanca') }}"  class="flex-fill mobile-menu__link  ">Línea Blanca</a><span class="mobile-menu__arrow js-mobile-menu__link-accordion--has-submenu"><i class="fa fa-angle-down mobile-menu__expand-icon" aria-hidden="true"></i><i class="fa fa-angle-up mobile-menu__close-icon" aria-hidden="true"></i></span><div class="mobile-menu__tab-row-break"></div>
...
<!-- /Block search module TOP -->
  ...
  <section id="main">
    ...
    <section id="content" class="@yield('content_class', 'page-home')">
        ...
        <div class="block-content rte-content">
            ...
            <div class="block-content">
                <ul>
                                                                        <li>
                                <a
                                        href="{{ route('tienda.content', '4-quienes-somos') }}"
                                        title=""                                                                        >
                                    Quiénes Somos
                                </a>
                            </li>
                                                                                                <li>
                                <a
                                        href="{{ route('tienda.content', '2-aviso-de-privacidad') }}"
                                    ...
                                    Aviso de Privacidad
                                                                                                ...
                                                                                                <li>
                                <a
                                        href="{{ route('tienda.content', '3-terminos-y-condiciones') }}"
        ...
        if (window.focus) {
            newWindow.focus();
                ...
                <div class="no-account">
                    <a href="{{ route('login') }}?create_account=1" data-link-action="display-register-form">
