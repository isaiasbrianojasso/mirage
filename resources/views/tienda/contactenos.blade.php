...
<script type="application/ld+json">
  ...
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [
            ...
            "position": 2,
            "name": "Contáctanos",
            "item": "/tienda_assets/contactenos"
          }          ]
    }
  </script>
    ...
    <meta property="og:url" content="/tienda_assets/contactenos"/>
    <meta property="og:site_name" content="Mirage"/>
    <meta property="og:description" content="Use nuestro formulario para contactarnos">
  ...
  <link rel="stylesheet" href="/tienda_assets/modules/ets_advancedcaptcha/views/css/front.css" type="text/css" media="all">
  ...
  <link rel="stylesheet" href="/tienda_assets/modules/iqitcontactpage/views/css/front.css" type="text/css" media="all">
...
<script src="https://www.google.com/recaptcha/api.js?&hl=mx" ></script>
<script type="text/javascript">
    var PA_GOOGLE_CAPTCHA_THEME = 'light';
            var PA_GOOGLE_V3_CAPTCHA_SITE_KEY = '6LcoH7IqAAAAAC60RkCOPa4Uk4qeuRvFG8mut0ZN';
...
<script type="text/javascript">
  ...
  <meta name="facebook-domain-verification" content="mv4vsw2zn9h4ptpxr8g2y6upq81xy8" />
    ...
    <body id="contact" class="lang-mx country-mx currency-mxn layout-full-width page-contact tax-display-enabled body-desktop-header-style-w-2       customer-not-logged">
...
<nav data-depth="2" class="breadcrumb">
  ...
  <header class="page-header">
    <h1 class="h1 page-title"><span>Contáctanos</span></h1>
  </header>
    ...
    <section class="contact-form">
        <form action="/tienda_assets/contactenos" method="post"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="id_contact"  id="id_contact"  class="form-control form-control-select">
                                                            ...
                                                            <option value="3">Garantias y Soporte Postventa</option>
                                                            <option value="5">Seguimiento de mi pedido</option>
                                                            <option value="2">Soporte de mi pedido</option>
                                                    </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        >
                                    ...
                                    <div class="form-group row">
                        <label class="col-md-3 form-control-label" for="file-upload">Adjuntar</label>
                        <div class="col-md-6">
          ...
          ></textarea>
            ...
            <footer class="form-footer text-right">
                ...
                <input type="hidden" name="token" value="f140c80d97ee48c9d70ac60c40b2f46b" />
...
if(window.location.pathname == "/content/4-quienes-somos" || window.location.pathname == "/content/2-aviso-de-privacidad" || window.location.pathname == "/content/3-terminos-y-condiciones")
{
  ...
  <script src="/tienda_assets/modules/ets_advancedcaptcha/views/js/front.js" ></script>
