...
<script type="application/ld+json">
  {
    ...
    "name": "Entrar",
    "url":  "/tienda/iniciar-sesion?back=my-account"
  }
</script>
  ...
  <script type="application/ld+json">
    ...
    <meta property="og:url" content="/tienda/iniciar-sesion?back=my-account"/>
...
<nav data-depth="2" class="breadcrumb">
  ...
  Inicio de sesión
    ...
    <form  id="login-form" action="/tienda/iniciar-sesion?back=my-account"    method="post">
...
if(window.location.pathname == "/content/4-quienes-somos" || window.location.pathname == "/content/2-aviso-de-privacidad" || window.location.pathname == "/content/3-terminos-y-condiciones")
{
    $(".page-header").css("display", "none");    
			...
			<script type="text/javascript">
$('.login-form').append('<div id="fbpsc" class="authentication advanced">Iniciar sesión a través de redes sociales<div class="clr_10"></div><p href=\"javascript:void(0)\" onclick=\"javascript:popupWin = window.open(\'/modules/facebookpsconnect/ws-facebookpsconnect.php?sAction=connect&sType=plugin&connector=facebook&back=/tienda/mi-cuenta\', \'login\', \'location,width=600,height=600,top=0\');popupWin.focus();\" class="btn-connect btn-block-connect btn-social btn-facebook"><span class="fa fa-facebook-square"></span><span class="btn-title-connect">Login with Facebook</span> </p><p href=\"javascript:void(0)\" onclick=\"javascript:popupWin = window.open(\'/modules/facebookpsconnect/ws-facebookpsconnect.php?sAction=connect&sType=plugin&connector=google&back=/tienda/mi-cuenta\', \'login\', \'location,width=600,height=600,top=0\');popupWin.focus();\" class="btn-connect btn-block-connect btn-social btn-google"><span class="btn-google-icon"></span><span class="btn-title-connect">Sign in with Google</span> </p></div>');
</script>
